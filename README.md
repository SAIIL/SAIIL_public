...
```
* Split the protobuf annotation file in train and test subsets (train: video01 - video40, test: video41 - 80). Or you can find the split annotations in the [link](https://shorturl.at/BLOW7).
